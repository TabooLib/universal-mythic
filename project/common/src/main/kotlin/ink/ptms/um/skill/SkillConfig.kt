...
interface SkillConfig {
    ...
    /** 获取带变量的字符串 */
    fun getPlaceholderString(key: String, def: String, vararg args: String): PlaceholderString
    ...
    /** 获取带变量的整数 */
    fun getPlaceholderInt(key: String, def: Int, vararg args: String): PlaceholderInt
    ...
    /** 获取带变量的浮点数（双精度）*/
    fun getPlaceholderDouble(key: String, def: Double, vararg args: String): PlaceholderDouble
    ...
    /** 获取带变量的浮点数（单精度）*/
    fun getPlaceholderFloat(key: String, def: Float, vararg args: String): PlaceholderFloat
